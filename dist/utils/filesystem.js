...
const replaceFileContent = async (pathlike, startOffset, endOffset, newContent) => {
    const { writeFile, readFile } = await Promise.resolve().then(() => __importStar(require("fs/promises")));
